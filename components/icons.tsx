// SVG icon set ported from the prototype `I` map. Strings are static and trusted,
// rendered inline so the existing CSS (`.btn svg`, `.icon-btn svg`, …) applies unchanged.
...
/** Inline SVG icon. `display:contents` keeps the existing `* svg` CSS selectors intact. */
